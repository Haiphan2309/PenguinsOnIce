...
public class PopupManager : MonoBehaviour
{
    ...
    [SerializeField] private UILosePanel uiLosePanelPrefab;
    ...
    public void ShowLosePanel(bool isTimeUp)
    {
        ShowBlackBg();
        UILosePanel uiLosePanel = Instantiate(uiLosePanelPrefab, canvasTrans);
        uiLosePanel.Show(isTimeUp);
    }
    public void ShowTutorial()
    {
        ShowBlackBg();
        UITutorial uiTutorial = Instantiate(uiTutorialPrefab, canvasTrans);
        uiTutorial.Show();
    }
